...
There by from this, one means the user can load up information and feed it into the drawProtein function, might be to use the file name for the name parameter for xml, and then the cvs data for the features data frame.
