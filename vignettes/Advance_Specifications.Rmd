...
This function is the main function to retrieve XML data from the UniProt API. It will handle all data retrieval for the user. It is exported primarily for use by the Shiny App

```r
webPageData <- uniprotProteinView::confirmStatus("Q04206", FALSE)
```
