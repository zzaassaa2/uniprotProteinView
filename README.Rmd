...
The uniprotProteinView package provides six functions, however the user will normally only need to use two: `drawProtein()`, the main drawing function, or `runUniprotProteinView()`, a function that opens up an interactive Shiny app. To see further documentatio
...
Otherwise the most simple usage of the function `drawProtein` is to supply it with a protein key_code, this can be found from the UniProt webpage at [UniProt](https://www.uniprot.org/) Once there, search for your protein and get the protein key_code
...
<div style="text-align:center"><img src="inst/extdata/first.png" width="800" height="450"/>
...
<div style="text-align:center"><img src="inst/extdata/second.png" width="800" height="450"/>
